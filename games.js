...
import yugioh from './yugioh.js?v=15';
import riftbound from './riftbound.js?v=15';
import pokemon from './pokemon.js?v=15';
import magic from './magic.js?v=15';
import onepiece from './onepiece.js?v=15';
